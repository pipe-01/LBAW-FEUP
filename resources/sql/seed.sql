...
CREATE INDEX search_product_idx ON product USING GIST (search);
...
$BODY$
BEGIN
    IF NOT EXISTS (SELECT stock 
                    FROM product
                    WHERE product.stock >= New.quantity)
...
VALUES 
  (1,'Joao Silva', 'jsilva@gmail.com', '$2y$10$K.is8ubpvmgT1/7l3NR.J.VB.0cWlHiRVUGcJO3sokNNcNlJ/FLrG', 'Rua Costa Cabral', 'Porto', 'Portugal'), --abcd123
  (2,'Jose Bacelar', 'josebacelar@gmail.com', '$2y$10$tSAkLdDaOnnW8CGf5nKktOWDjhxp5wyUZ4LR7RGBGzIe5l7QX5WHi', 'Avenida Fernão Magalhães', 'Porto', 'Portugal'), --password
...
VALUES 
  ...
  VALUES 
  (101,'Benedita Bacelar', 'bbacelar@smart.pt', '$2a$04$vsE76hRak0H8LDGxsgUt1.YAJJ79q1Z0eSiR2nVDagMd1FaHKYHBm', TRUE), --pass: admin123
  (102,'Ricardo Pinto', 'rpinto@smart.pt', '$2a$04$vsE76hRak0H8LDGxsgUt1.YAJJ79q1Z0eSiR2nVDagMd1FaHKYHBm', TRUE),
  (103,'Afonso Carvalho', 'acarvas@smart.pt', '$2a$04$Xp0vWzrXugeFD5CapTfzAOoMev8V.KQ6Ec8lKAQJBvjuACzxCFU4e', TRUE),
  (104,'Filipe Pinto', 'fpinto@smart.pt', '$2a$04$Xp0vWzrXugeFD5CapTfzAOoMev8V.KQ6Ec8lKAQJBvjuACzxCFU4e', TRUE);
...
VALUES 
(1,'Benedita Bacelar', 'bbacelar@smart.pt', '$2a$04$Xp0vWzrXugeFD5CapTfzAOoMev8V.KQ6Ec8lKAQJBvjuACzxCFU4e', 1), --pass: admin
(2,'Ricardo Pinto', 'rpinto@smart.pt', '$2a$04$Xp0vWzrXugeFD5CapTfzAOoMev8V.KQ6Ec8lKAQJBvjuACzxCFU4e', 2),
(3,'Afonso Carvalho', 'acarvas@smart.pt', '$2a$04$Xp0vWzrXugeFD5CapTfzAOoMev8V.KQ6Ec8lKAQJBvjuACzxCFU4e', 3),
(4,'Filipe Pinto', 'fpinto@smart.pt', '$2a$04$Xp0vWzrXugeFD5CapTfzAOoMev8V.KQ6Ec8lKAQJBvjuACzxCFU4e', 3);
*/
...
--Product Population --
-- 42 Products
INSERT INTO product(id, title, type, price, description, stock, artist_id) --Syntax error ?????
VALUES

--Banksy
(1,'Love is in the Air', 'Painting', 6000000.0, 'Tagged on the turnover edge. Signed by Banksy. Dated May 2006 and numbered out of 15. Oil and spray paint on canvas. 90 by 90 cm',10,1),

(2,'Pulp Fiction', 'Painting', 65000.0, 'Screenprint in colours, 2004, numbered out of 600, published by Pictures on Walls, London, on wove paper, unframed. 48.5 by 69.8 cm',4,1),
(3,'I Fought The Law', 'Painting', 32280.0, 'Screenprint in colours, 2005, numbered out of 500, with the publisher s blindstamp, Pictures on Walls, London, on wove paper. 66.1 by 66.2 cm',5,1),
(4,'Jack and Jill', 'Painting', 63500.0, 'Screenprint in colours, 2004, signed in pencil, dated, numbered out of 350, with the publisher s blindstamp, Pictures on Walls, London, on wove paper. 45 by 65 cm',10,1),
(5,'Toxic Mary', 'Painting', 30240.0, 'Screenprint in colours, 2004, numbered out of600, published by Pictures on Walls, London, on wove paper. 69.6 by 49.6 cm',10,1),

--Takashi
(6,'Panda with Panda Cubs', 'Painting', 1386.0, 'Offset lithograph printed in colours, 2019, signed in black ink, numbered 45/300, published by Kaikai Kiki Co., Ltd., Tokyo, on smooth wove paper, unframed diameter: 71cm',10,2),
(7,'Teleportation', 'Painting', 100000.0, 'signed and dated 2016 on the overlap. Platinum sheet on canvas mounted on aluminum frame. 41.9 by 33.5 cm.',5,2),
(8,'Contemplating Dark Matter', 'Painting', 403200.0, 'signed and dated 2014 on the overlap. Acrylic, gold and platinum leaf on canvas. 100.3 by 100.3 cm.',3,2),
...
sheet: 400 by 399mm',12,3),
(10,'Infinity Nets','Painting',7500.0, 'dated 1989 and variously inscribed in Japanese on the reverse acrylic on canvas. 31.8 by 41 cm. 12½ by 16⅛ in. Framed: 51.2 by 60.5 cm.',7,3),

-- Kerry James Marshall
(11,'The Wonderfull One','Painting', 1774500.0,' signed and dated 1986. Charcoal on paper. 127 by 96.5 cm. framed: 130.8 by 70.8 cm. Executed in 1986.',10,4),
(13,'Kerry James Marshall','Painting', 541000.0 ,'Vignette acrylic on fiberglass, in artists frame',1,4),

--Kith Haring
(14,'Untitled (Totem)','Sculpture', 200000.0 ,'Enamel on carved wood. 403.9 by 127 by 127 cm. Executed in 1983.',5,5),
(15,'Fight AIDS Worldwide','Painting', 3528.0,'Lithograph printed in black and orange, 1990, numbered out of 1000. Has the Keith Haring Estate inkstamp verso signed by the executor Julia Gruen, with the publishers blindstamp. World Federation of United Nations Associations, New York. On wove paper. Unframed',25,5),
...
sheet: 762 by 509mm',2,6),
(17,'Dollar Sign','Painting', 927500.0 ,'acrylic and silkscreen ink on canvas. 50.8 by 40.6 cm. Executed in 1981. This work is stamped by the Estate of Andy Warhol and The Andy Warhol Foundation for the Visual Arts, Inc. and numbered PA30.050 on the reverse. This work is also numbered PA30.050 on the stretcher.',3,6),

--Damian Herst
(18,'For the Love of God, Laugh', 'Painting', 10250.0, 'Silkscreen print with glazes and diamond dust on paper. Signed. Numbered out of 250 on the reverse. Executed in 2007. 100 by 74.5 cm',4,7),
(19,'Lysergic Acid Diethylamide (LSD)', 'Painting', 22680.0, 'Lambda inkjet print in colors, 2000, signed in black felt-tip pen and numbered 111/300 in pencil on the verso, on gloss Fujicolor professional paper, published by Eyestorm, London, framed. 114.2 by 134.8 cm',4,7),
(20,'Enter the Infinite (The Visions), Ecstasy', 'Painting', 151200.0, 'Signed and numbered out od 20 on a label affixed to the reverse. Jacquard-woven tapestry. Executed in 2016. 252.5 by 254 cm.',5,7),
...
panel: 39 by 39cm.',55,7),
(22,'Untitled (Skull Spin Painting), 2009', 'Painting', 5470.0, 'Acrylic and metallic painting on paper. Signed, stamped with the artist s copyright and marked with the studio s blind stamp on the reverse. 71 x 51 cm (unframed).',2,7),
(23,'Valium', 'Painting', 27720.0, 'Lambda print in colours. 2000. Signed in black felt-tip pen. Numbered out of 500 in verso, on gloss Fuji archive paper. Sheet: 120 by 120cm.',50,7),

-- Paula Rego
(24,'After Zurbarán','Painting', 157500.0 ,'Charcoal and pastel on paper. 136 by 101 cm. Executed in 2007.',10,8),
(25,'Island of the Lights from Pinocchio','Painting', 180000.0,'Painting by Paula Rego',1,8),

--Mary Frank
(26,'Head of a Woman','Sculpture', 2042.0, 'Made from terracota in 1975. Height: 34.92 cm, Width: 30.61 cm, Depth: 20.32 cm',4,9),
(27,'Lovers Kissing','Sculpture', 1779.0 ,' Made from terracota in 1975. Height: 22.53 cm, width: 29.84 cm, depth: 10.5 inches / 26.67 cm',4,9),

--Morten Løbner Espersen
(28,'Green and Black Horror','Sculpture', 12486.0,'Created in 2013 made from glazed stoneware. Height: 44.96 cm, width: 32 cm, depth: 32 cm',3,10),
(29,'Red Horror','Sculpture', 16050.0,'Created in 2013 made from glazed stoneware. Height: 53.09 cm, width: 41.91 cm, depth: 41.91 cm',5,10),
(30,'Horror Vacui (blue/matte black)','Sculpture', 15159.0 ,'Created in 2014 made from glazed stoneware. Height: 54.99 cm, width: 38.99 cm, depth: 38.99 cm',4,10),
(31,'Dry Whisper','Sculpture', 53487.0,'Created in 2012 made from glazed stoneware. Diameter: 88.9 cm',5,10),
(32,'Blood Moon #1','Sculpture', 19617.0 ,'Created in 2015 made from glazed stoneware. Height: 51.99 cm, diameter: 50.01 cm',7,10),
(33,'Horror Vacui Yellow','Sculpture', 16044.0 ,'Created in 2020 made from glazed stoneware.Height: 69.01 cm, diameter: 57.99 cm.',5,10),
(34,'Pale Green Horror Vacui Tilt','Sculpture', 15248.0 ,'Created in 2020 made from glazed stoneware.Height: 53.01 cm, diameter: 38.73 cm.',2,10),
(35,'Glazed Pearl','Sculpture', 3387.0 ,'Created in 2019 made from glazed stoneware. Marked on underside. Height: 16.99 cm, diameter: 18.01 cm.',1,10),

--Joan Miró
(36,'Tête au soleil couchant (Dupin 437)','Painting', 1080 ,'Etching printed in colors with aquatint and carborundum, 1967, signed in pencil and numbered out od 75, on Arches wove paper, printed and published by Maeght, Paris, framed. Dimensions: 665 by 744 mm.',5,11),
(37,'La Fronde (Dupin 501)','Painting', 18900,'Etching and aquatint printed in colors with carborundum, 1969, signed in white pencil and numbered out of 75, on Arches wove paper, published by Maeght, Paris. Framed. Dimensions: 1196 by 836 mm',2,11),
(38,'La femme Angora (Dupin 499)','Painting', 16380.0 ,'Etching and aquatint printed in colors with carborundum, 1969, signed in pencil and numbered out of 75, on Arches wove paper, published by Maeght, Paris, framed. Dimensions: 1295 by 940 mm.',29,11),
(39,'Untitled','Painting', 2300.0,'This piece was created for the opening of the Fundació Joan Miró. Lithograph printed in colours, 1976, signed in pencil. Numbered out of 99. Done on wove paper. Unframed. Dimensions 697 by 498mm',3,11),
(40,'Maquette de lArc de la Fondation Maeght','Sculpture', 252000.0 ,'Signed Miró and stamped with the foundry mark Susse Fondeur Paris. Height: 41,8 cm. Conceived in 1962 and cast in bronze in 1979 in an edition of 8.',5,11),
(41,'Tête et oiseau','Sculpture', 210000.0,'Signed Miró abdstamped with the foundry mark Scuderi Cire Perdue. Height: 48.3cm. Conceived and cast in 1971 in a edition of 3, numbered 0/2 - 2/2, plus one nominative version cast in 1973.',1,11),

-- NFTs
(12,'Crypto Punks','NFT', 350000.0 ,'10,000 unique CryptoPunks available in the Ethereum Blockchain.',10000,12),
(42, 'Bored Apes', 'NFT', 100000.0, '10,000 unique Bored Apes, which unsuccessfully attempt to reach CryptoPunk status, but are still very rare and valuable.',10000,12);

INSERT INTO image(id, image_path, product_id, main) VALUES
--Banksy
(1, 'images/love_is_in_the_air.jpg', 1, TRUE),
(2, 'images/pulp_fiction.jpg', 2, TRUE),
(3, 'images/pulp_fiction2.jpg', 2, FALSE),
(4, 'images/fought_the_law.jpg', 3, TRUE),
(5, 'images/fought_the_law2.jpg', 3, FALSE),
(6, 'images/jack_and_jill.jpg', 4, TRUE),
(7, 'images/jack_and_jill2.jpg', 4, FALSE),
(8, 'images/toxic_mary.jpg', 5, TRUE),
(9, 'images/toxic_mary2.jpg', 5, FALSE),

--Takashi
(10, 'images/panda.jpg', 6, TRUE),
(11, 'images/panda2.jpg', 6, FALSE),
(12, 'images/teleportation.jpg', 7, TRUE),
(13, 'images/contemplating.jpg', 8, TRUE),

--Yayoi Kusama
(14, 'images/endless_life.jpg', 9, TRUE),
(15, 'images/endless_life2.jpg', 9, FALSE),
(16, 'images/infinity_nets.jpg', 10, TRUE),
(17, 'images/infinity_nets2.jpg', 10, FALSE),

-- Kerry James Marshall
(66, 'images/wonderful_one.jpg', 11, TRUE),
(67, 'images/wonderful_one2.jpg', 11, FALSE),
(68, 'images/untitled_kjm.jpeg', 13, TRUE), 

--Kith Haring
(19, 'images/untitled_totem.jpg', 14, TRUE),
(20, 'images/untitled_totem2.jpg', 14, FALSE),
(21, 'images/fight_aids.jpg', 15, TRUE),
(22, 'images/fight_aids2.jpg', 15, FALSE),

-- Andy Warhol
(23, 'images/committe.jpg', 16, TRUE),
(24, 'images/committe2.jpg', 16, FALSE),
(25, 'images/dollar_sign.jpg', 17, TRUE),


--Damien Herst
(26, 'images/love_of_god.jpg', 18, TRUE),
(27, 'images/love_of_god2.jpg', 18, FALSE),
(28, 'images/lsd.jpg', 19, TRUE),
(29, 'images/lsd2.jpg', 19, FALSE),
(30, 'images/ecstasy.jpg', 20, TRUE),
(31, 'images/ecstasy2.jpg', 20, FALSE),
(32, 'images/fruitfall_small.jpeg', 21, TRUE),
(33, 'images/fruitfall_small2.jpeg', 21, FALSE),
(34, 'images/untitled_skull.jpg', 22, TRUE),
(35, 'images/untitled_skull2.jpg', 22, FALSE),
(36, 'images/untitled_skull3.jpg', 22, FALSE),
(37, 'images/valium.jpg', 23, TRUE),
(38, 'images/valium2.jpg', 23, FALSE),

-- Paula Rego
(39, 'images/after_zurbaran.jpg', 24, TRUE),
(40, 'images/island_of_light.jpg', 25, TRUE),

--Mary Frank
(41, 'images/head_woman.png', 26, TRUE),
(42, 'images/head_woman2.jpg', 26, FALSE),
(43, 'images/lovers_kissing.png', 27, TRUE),

--Morten Løbner Espersen
(44, 'images/green_black_horror.png', 28, TRUE),
(45, 'images/red_horror.png', 29, TRUE),
(46, 'images/horror_vacui.jpg', 30, TRUE),
(47, 'images/horror_vacui2.jpg', 30, FALSE),
(48, 'images/dry_whisper.png', 31, TRUE),
(49, 'images/blood_moon.png', 32, TRUE),
(50, 'images/horror_vacui_yellow.png', 33, TRUE),
(51, 'images/pale_green_horror.png', 34, TRUE),
(52, 'images/glazed_pearl.png', 35, TRUE),

--Joan Miró
(53, 'images/tete_au_soleil.jpg', 36, TRUE),
(54, 'images/tete_au_soleil2.jpg', 36, FALSE),
(55, 'images/la_fronde.jpg', 37, TRUE),
(56, 'images/la_fronde2.jpg', 37, FALSE),
(57, 'images/la_femme_angora.jpg', 38, TRUE),
(58, 'images/la_femme_angora2.jpg', 38, FALSE),
(59, 'images/untitled.jpg', 39, TRUE),
(60, 'images/untitled2.jpg', 39, FALSE),
(61, 'images/maquette_larc_fondation.jpg', 40, TRUE),
(62, 'images/maquette_larc_fondation2.jpg', 40, FALSE),
(63, 'images/tete_et_oiseau.jpg', 41, TRUE),
(64, 'images/tete_et_oiseau2.jpg', 41, FALSE),

-- NFTs
(65, 'images/bored_ape.jpeg', 42, TRUE),
(69, 'images/crypto_punk.jpeg', 12, TRUE);
...
SELECT setval(pg_get_serial_sequence('user', 'id'), max(id)) FROM "user"; -- atualiza id de user para fazer register