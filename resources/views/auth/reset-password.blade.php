        ...
        <section class="d-flex align-items-center justify-content-center">
            <div class="container-lg text-center">
                <form class="form-reset-password" method="POST" action="{{ route("password.update") }}">
                    ...
                    <label for="inputEmail" class="sr-only float-start">Enter Email</label>
                    <input type="text" id="inputEmail" class="form-control" name="email" value="{{ old('email') }}" required>

                    <label for="password" class="sr-only float-start">Enter New Password</label>
                    <input type="password" id="password" class="form-control" name="password" required>

                    <label for="password-confirm" class="sr-only float-start">Comfirm New Password</label>
